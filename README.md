...
- Executed React and Next.js apps using best practices and Design Systems that delivered multiple UI components in 7 days

- Designed using TDD and Typescript for ERP app that reduced SDLC by 75%
